            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Issued Details</li>
                </ol>
              </nav>
            </div>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Issued Details</h3>
                </div>
                <div class="col-4 text-right">
                  <a href="<?php echo base_url()?>issue/editissue/<?php echo $this->uri->segment(3)?>" class="btn btn-sm btn-primary">Edit</a>
                </div>
              </div>
            </div>
            <?php
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control" disabled placeholder="Username" value="<?php echo $data->issued?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Return Date</label>
                        <input type="text" id="input-email" class="form-control" disabled  placeholder="" value="<?php echo $data->return?>" >
                      </div>
                    </div>
                  </div>
                  <div class="row">
