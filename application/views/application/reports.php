          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row align-items-center mb-2">
                <div class="col-8">
                  <p class="mb-0">Book List</p>
                </div>
                <div class="col-4 text-right">
                  <a class="btn btn-sm btn-primary text-white save-btn" href="<?php echo base_url()?>reports/booklist">download</a>
                </div>
              </div>
              <div class="row align-items-center mb-2">
                <div class="col-8">
                  <p class="mb-0">Issued Book</p>
                </div>
                <div class="col-4 text-right">
                  <a class="btn btn-sm btn-primary text-white save-btn" href="<?php echo base_url()?>reports/issuebook">download</a>
                </div>
              </div>
              <div class="row align-items-center mb-2">
                <div class="col-8">
                  <p class="mb-0">Returned Book</p>
                </div>
                <div class="col-4 text-right">
                  <a class="btn btn-sm btn-primary text-white save-btn" href="<?php echo base_url()?>reports/returnbook">download</a>
                </div>
              </div>
              <div class="row align-items-center mb-2">
                <div class="col-8">
                ...
                <div class="col-4 text-right">
                  <a class="btn btn-sm btn-primary text-white save-btn" href="<?php echo base_url()?>reports/categories">download</a>
                </div>
              </div>
              <div class="row align-items-center mb-2">
                <div class="col-8">
                ...
                <div class="col-4 text-right">
                  <a class="btn btn-sm btn-primary text-white save-btn" href="<?php echo base_url()?>reports/students">download</a>
                </div>
              </div>
              <div class="row align-items-center mb-2">
                <div class="col-8">
                ...
                <div class="col-4 text-right">
                  <a class="btn btn-sm btn-primary text-white save-btn" href="<?php echo base_url()?>reports/admin">download</a>
                </div>
              </div>
            </div>
          </div>
